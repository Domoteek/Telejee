...
6.04.2017:: Charte graphique. Possibilité de créer des télécommandes (voir doc : 2 pour le moment mais en réfléxion et si demande n'hésitez pas à faire la demande sur le forum). Pas besoin de réinstaller aprés installation. Mise à jour de la la doc.
